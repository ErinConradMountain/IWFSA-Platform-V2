...
const modules = ["activation", "audit", "auth", "component-contracts", "consent", "design-tokens", "events", "import-pipeline", "persistence", "policy", "repositories", "runtime", "session-repository", "standing", "telemetry"];
