...
const modules = ["activation", "audit", "auth", "component-contracts", "consent", "design-tokens", "events", "import-pipeline", "notification-policy", "notification-provider", "outbox", "persistence", "policy", "public-approval", "public-approval-repository", "public-profile-repository", "repositories", "runtime", "session-repository", "standing", "telemetry", "visibility"];
