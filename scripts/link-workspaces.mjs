...
const modules = ["activation", "audit", "auth", "component-contracts", "consent", "design-tokens", "events", "import-pipeline", "persistence", "policy", "public-approval", "public-profile-repository", "repositories", "runtime", "session-repository", "standing", "telemetry", "visibility"];
