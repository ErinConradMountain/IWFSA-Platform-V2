...
const steps = [
  ...
  ["node", ["--experimental-strip-types", "scripts/reviewer-walkthrough-smoke.mjs"]],
  ...
  ["node", ["scripts/phase9-notifications-check.mjs"]],
  ["node", ["scripts/phase10-readiness-check.mjs"]],
